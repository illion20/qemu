...
uint32_t HELPER(stsi)(CPUS390XState *env, uint64_t a0, uint64_t r0, uint64_t r1)
{
    ...
    case STSI_R0_FC_LEVEL_1:
        if ((sel1 == 1) && (sel2 == 1)) {
            ...
            /* Basic Machine CPU */
            ebcdic_put(sysib.sysib_121.sequence, "DELLDELLDELLDELL", 16);
    ...
    case STSI_R0_FC_LEVEL_2:
        if ((sel1 == 2) && (sel2 == 1)) {
            /* LPAR CPU */
            ebcdic_put(sysib.sysib_221.sequence, "DELLDELLDELLDELL", 16);
    ...
    case STSI_R0_FC_LEVEL_3:
        if ((sel1 == 2) && (sel2 == 2)) {
            ...
            ebcdic_put(sysib.sysib_322.vm[0].cpi, "DELL/Linux      ", 16);
